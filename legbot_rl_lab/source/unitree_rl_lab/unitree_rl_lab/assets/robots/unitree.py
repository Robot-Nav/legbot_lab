...
UNITREE_ROS_DIR = "/home/fatu08/legbot_mujoco/legbot_rl_lab/unitree_ros"
...
UNITREE_LEGBOT_CFG.spawn.replace_asset(
    urdf_path=f"{UNITREE_ROS_DIR}/robots/legbot_description/urdf/legbot_description.urdf",
    package_root=f"{UNITREE_ROS_DIR}/robots/legbot_description",
    robot_name="legbot",
)
