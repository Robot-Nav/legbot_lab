...
class LegBotBridgeBase
{
public:
    LegBotBridgeBase(mjModel *model, mjData *data)
...
class LegBotBridge : public LegBotBridgeBase
{
public:
    LegBotBridge(mjModel *model, mjData *data) : LegBotBridgeBase(model, data)
    {
