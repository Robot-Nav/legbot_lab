...
@dataclass
class LegBotStairsEnvCfg(LegBotEnvCfg):
...
@registry.envcfg("LegBotStairsMultiTarget-v0")
@dataclass
class LegBotStairsMultiTargetEnvCfg(LegBotStairsEnvCfg):
...
@dataclass
class LegBotStairsObstaclesEnvCfg(LegBotStairsEnvCfg):
    """LegBot楼梯地形带障碍球的导航配置"""
...
@dataclass
class LegBotSection01EnvCfg(LegBotStairsEnvCfg):
...
@dataclass
class LegBotSection02EnvCfg(LegBotStairsEnvCfg):
...
@dataclass
class LegBotSection03EnvCfg(LegBotStairsEnvCfg):
...
@dataclass
class LegBotLongCourseEnvCfg(LegBotStairsEnvCfg):
...
@dataclass
class LegBotSection001EnvCfg(LegBotStairsEnvCfg):
    """LegBot Section01单独训练配置 - 高台楼梯地形"""
