"""Script to train RL agent with MoE+CTS using RSL-RL."""
...
parser = argparse.ArgumentParser(description="Train an RL agent with RSL-RL MoE+CTS.")
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    """Train with RSL-RL MoE+CTS agent."""
    ...
    runner = OnPolicyRunnerCTS(env, cfg_dict, log_dir=log_dir, device=agent_cfg.device)
