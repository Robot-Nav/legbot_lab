...
UNITREE_ROS_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(
    os.path.dirname(os.path.abspath(__file__))))))), "unitree_ros")
    ...
    def replace_asset(self, urdf_path, package_root=None, robot_name="robot"):
        ...
        if package_root and os.path.isdir(package_root):
            for item in os.listdir(package_root):
                ...
                if item != os.path.basename(urdf_path) and not os.path.exists(dst):
                    os.symlink(src, dst)
...
if os.path.exists(f"{UNITREE_ROS_DIR}/robots/go2_description/urdf/go2_description.urdf"):
    UNITREE_GO2_CFG.spawn.replace_asset(
        urdf_path=f"{UNITREE_ROS_DIR}/robots/go2_description/urdf/go2_description.urdf",
        package_root=f"{UNITREE_ROS_DIR}/robots/go2_description",
        robot_name="go2",
    )
...
if os.path.exists(f"{UNITREE_ROS_DIR}/robots/go2w_description/urdf/go2w_description.urdf"):
    UNITREE_GO2W_CFG.spawn.replace_asset(
        urdf_path=f"{UNITREE_ROS_DIR}/robots/go2w_description/urdf/go2w_description.urdf",
        package_root=f"{UNITREE_ROS_DIR}/robots/go2w_description",
        robot_name="go2w",
    )
...
if os.path.exists(f"{UNITREE_ROS_DIR}/robots/b2_description/urdf/b2_description.urdf"):
    UNITREE_B2_CFG.spawn.replace_asset(
        urdf_path=f"{UNITREE_ROS_DIR}/robots/b2_description/urdf/b2_description.urdf",
        package_root=f"{UNITREE_ROS_DIR}/robots/b2_description",
        robot_name="b2",
    )
...
if os.path.exists(f"{UNITREE_ROS_DIR}/robots/h1_description/urdf/h1.urdf"):
    UNITREE_H1_CFG.spawn.replace_asset(
        urdf_path=f"{UNITREE_ROS_DIR}/robots/h1_description/urdf/h1.urdf",
        package_root=f"{UNITREE_ROS_DIR}/robots/h1_description",
        robot_name="h1",
    )
...
UNITREE_VBOT_CFG = UnitreeArticulationCfg(
    spawn=UnitreeUrdfFileCfg(
        asset_path=f"{UNITREE_ROS_DIR}/robots/vbot_description/urdf/vbot_description.urdf",
    ),
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 0.462),
        joint_pos={
    ...
    actuators={
        "VbotHipThigh": unitree_actuators.UnitreeActuatorCfg_VbotHipThigh(
            joint_names_expr=[".*_hip_.*", ".*_thigh_.*"],
            stiffness=80.0,
            damping=6.0,
            friction=0.01,
        ),
        "VbotCalf": unitree_actuators.UnitreeActuatorCfg_VbotCalf(
            joint_names_expr=[".*_calf_.*"],
            stiffness=80.0,
            damping=6.0,
            friction=0.01,
...
UNITREE_VBOT_CFG.spawn.replace_asset(
    urdf_path=f"{UNITREE_ROS_DIR}/robots/vbot_description/urdf/vbot_description.urdf",
    package_root=f"{UNITREE_ROS_DIR}/robots/vbot_description",
    robot_name="vbot",
)
