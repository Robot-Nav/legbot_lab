...
class ActionsCfg:
    ...
    joint_pos = mdp.JointPositionActionCfg(
        asset_name="robot",
        joint_names=LEGBOT_LEG_JOINT_NAMES,
...
class EventCfg:
    ...
    reset_base = EventTerm(
        ...
        mode="reset",
        params={
            "pose_range": {"x": (-0.5, 0.5), "y": (-0.5, 0.5), "z": (0.0, 0.05), "yaw": (-3.14, 3.14)},
            "velocity_range": {
                "x": (-0.5, 0.5),
                "y": (-0.5, 0.5),
                "z": (-0.5, 0.5),
...
class RewardsCfg:
    ...
    joint_acc_l2 = RewTerm(
        ...
        weight=-1.0e-7,
        params={"asset_cfg": SceneEntityCfg("robot", joint_names=ALL_JOINT_NAMES)},
    )
    joint_power = RewTerm(
    ...
    joint_pos_limits = RewTerm(
        ...
        weight=-2.0,
        params={"asset_cfg": SceneEntityCfg("robot", joint_names=LEGBOT_LEG_JOINT_NAMES)},
    )
...
class CurriculumCfg:
    ...
    base_height_l2 = CurrTerm(
        mdp.gradual_reward_weight_modification,
        params={"term_name": "base_height_l2", "initial_weight": -1.0, "final_weight": -10.0, "start_it": 0, "end_it": 5000},
    )
