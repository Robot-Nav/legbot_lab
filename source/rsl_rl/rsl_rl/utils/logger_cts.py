...
class LoggerCTS:
    ...
    def __init__(
        ...
        self.tot_time = 0
        self.teacher_env_idxs = teacher_env_idxs  # 教师环境在总环境中的索引
